...
* Please use dedicated support forum https://ask.crunchify.com/c/crunchy-social-sharing to leave comments, ask question, suggest new feature.

= Where can I report an issue? =
* Please email me directly on app [at] crunchify.com.

== Screenshots ==

1. Crunchy Sharing Admin Panel - Default Options
2. Crunchy Sharing Admin Panel - Floating Options
3. Crunchy Sharing Admin Panel - Common Options
4. Icon Style
5. Block Wide Style
6. Block Square Style
7. Button Style
8. Rounded Style
9. Bar Style
10. Circle Style
11. Simple Style
12. Floating Icon Style
13. Floating Block Wide Style
14. Floating Block Square Style
...
1. Unpack the crunchy-sharing.zip.
2. Upload the file to the /wp-content/plugins/ directory.
3. Activate the plugin through the Plugins menu in WordPress.
4. Configure the options under Admin Panel Crunchy Sharing -> General Options.
5. Activate your license by putting your activation key which you got in your email under Admin Panel Crunchy Sharing -> Activate License.
6. Done and Ready.
...
* Mobile Sticky button height and padding top CSS change
* Round button padding fix
* Fixed social sharing button link color
* Fixed click on focus color change to match with existing theme

= 3.5.0 =
* Bug fixes and performance improvements
* Compatibility with WordPress 5.6.0

= 3.4.0 =
* Bug fixes and performance improvements
* Fixed sharing icon button line height issue. Added line height CSS property.
* Fixed Circle icon button line height issue. Added line height CSS property.
* Removed floating bar color issue for simple style.
* Fixed Mail icon not showing up issue for floating bar.
* Fixed and issue for undefined variables.
* Compatibility with WordPress 5.5.1.
* Upgraded font-awesome CSS to 5.14.0.
* Changed enqueue style name to crunchy-sharing-fontawesome to avoid conflict with other plugins.

= 3.3.0 =
* Bug fixes and performance improvements
* Compatibility with WordPress 5.4.2
* Fixed WhatsApp sharing link
...
= 3.1.0 =
* Mobile bottom sticky sharing button option added
